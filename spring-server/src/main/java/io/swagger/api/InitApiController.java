...
public class InitApiController implements InitApi {
    ...
    public ResponseEntity<InlineResponse200> initGet() {
    ...
    public ResponseEntity<InlineResponse200> initLaunchAdGet(@NotNull @ApiParam(value = "屏幕宽度", required = true) @Valid @RequestParam(value = "width", required = true) BigDecimal width,@NotNull @ApiParam(value = "屏幕高度", required = true) @Valid @RequestParam(value = "height", required = true) BigDecimal height) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{  \"Common\" : {    \"code\" : 0,    \"message\" : \"message\"  }}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse200> initUpdateGet() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{  \"Common\" : {    \"code\" : 0,    \"message\" : \"message\"  }}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
